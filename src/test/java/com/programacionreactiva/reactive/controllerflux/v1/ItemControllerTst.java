package com.programacionreactiva.reactive.controllerflux.v1;
...
public class ItemControllerTst {
    ...
    public void getOneItem(){
        webTestClient.get().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"),"QWERT")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.price", 200L );
    ...
    public void getOneItem_notFound(){
        webTestClient.get().uri(ItemConstants.ITEM_END_POINT_V1.concat("{id}"),"asd")
                .exchange()
    ...
    public void createItem(){
        Item item = new Item(null, "Huawei nova 8", 999L);
        ...
        webTestClient.post().uri(ItemConstants.ITEM_END_POINT_V1)
                ...
                .jsonPath("$.description").isEqualTo("Huawei nova 8")
                .jsonPath("$.price").isEqualTo(999L);
    ...
    public void deleteItem(){
        webTestClient.delete().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"),"QWERT")
    ...
    public void updateItem(){
        ...
        webTestClient.put().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"), "QWERT")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
    ...
    public void updateItem_notFound(){
        ...
        Item item = new Item(null, "Apple watch", precioNuevo);
        //siempre fijarce que al crear la uri este igual y que no falte ningun / o letra etc
        webTestClient.put().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"), "QWERTY")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
